{{-- @extends('template_backend.main', ['title' => 'Post'])
@section('container')
<div class="section-header">
    <h1>Posts</h1>
    <div class="section-header-button" id="status">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <div class="table-links">
                                    <button class="d-inline text-info"><a href="#" class="text-info">View</a></button>
                                    <button class="d-inline text-info"><a
                                            href="{{ route('posts.edit', $post->slug) }}">Edit</a></button>
                                    <form class="d-inline" action="{{ route('posts.destroy', $post->slug) }}"
                            ...
                            <tr>
                                ...
                                <td>{{ $item->judul }}
                                    <div class="table-links">
                                        <a href="#">View</a>
                                        <button class="d-inline text-info"><a
                                                href="{{ route('posts.edit', $item->slug) }}">Edit</a></button>
                                        <form class="d-inline" action="{{ route('posts.destroy', $item->slug) }}"
                                            method="post" onsubmit="return submitForm(this);">
                                            @method('delete')
                                            @csrf
                                            <button class="text-danger" type="submit">Trash</button>
